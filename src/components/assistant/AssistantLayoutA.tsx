  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold mb-2">AI Assistant Dashboard</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1 border-brand/30 bg-gradient-to-br from-background to-brand/5">
          <CardHeader>
          ...
          <CardContent className="flex flex-col items-center py-8">
            ...
            <div className="relative mb-6">
              <div className="w-32 h-32 rounded-full bg-gradient-to-br from-brand/20 to-brand/5 flex items-center justify-center">
                <div
                  className={`w-24 h-24 rounded-full bg-gradient-to-br from-brand to-brand-glow flex items-center justify-center transition-all duration-500 ${
                    status === "running"
                      ? pulsePhase === 0 ? 'scale-100 shadow-[0_0_30px_hsl(var(--brand)/0.5)]' :
                        pulsePhase === 1 ? 'scale-105 shadow-[0_0_50px_hsl(var(--brand)/0.7)]' :
                        'scale-95 shadow-[0_0_20px_hsl(var(--brand)/0.3)]'
                  ...
                  <div key={index} className="flex items-start gap-3 p-3 rounded-lg bg-muted/30">
                    ...
                    <div className="flex-1">
                      <p className={`text-sm ${
                        ...
                        item.type === 'task' ? 'text-brand' :
                        item.type === 'thinking' ? 'text-warning' : ''
                      }`}>{item.action}</p>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-brand">{completedCount}</span>
              </div>
              <div className="flex justify-between items-center">
      ...
      {status === "completed" && (
        <div className="mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <Card className="border-success/30 bg-gradient-to-br from-background to-success/5">
            <CardHeader>
              ...
              <Tabs defaultValue="email" className="w-full">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 rounded bg-danger/10 border border-danger/20">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <Badge className="bg-danger/20 text-danger text-xs">Urgent</Badge>
                        </div>
                      ...
                      <div className="p-3 rounded bg-warning/10 border border-warning/20">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <Badge className="bg-warning/20 text-warning text-xs">High</Badge>
                        </div>
                      ...
                      <div className="pt-3 border-t border-border text-sm text-muted-foreground">
                        <span className="text-brand">12 newsletters</span> flagged for batch processing • <span className="text-brand">8 automated replies</span> sent
                      </div>
                    </div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="response">
                  <div className="rounded-lg border border-border bg-card">
                    ...
                    <div className="p-4 space-y-4 text-sm">
                      ...
                      <p>Based on your team size (50 users) and integration needs, I recommend our <span className="text-brand font-medium">Professional tier at $89/user/month</span>, which includes:</p>
                      ...
                      <p>I've attached a detailed comparison with your current solution showing potential <span className="text-success font-medium">cost savings of 23% annually</span>.</p>
                ...
                <TabsContent value="meeting">
                  <div className="rounded-lg border border-border bg-card p-4">
                    <div className="flex items-start gap-4 mb-4">
                      <div className="w-16 h-16 rounded-lg bg-brand/20 flex flex-col items-center justify-center">
                        <span className="text-xs text-brand">THU</span>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-brand">Zoom (link attached)</p>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex items-center gap-2"><Check className="h-3 w-3 text-success" /><span>Sarah Chen</span><Badge variant="outline" className="text-xs">Confirmed</Badge></div>
                          <div className="flex items-center gap-2"><Check className="h-3 w-3 text-success" /><span>Michael Rodriguez</span><Badge variant="outline" className="text-xs">Confirmed</Badge></div>
                          <div className="flex items-center gap-2"><Circle className="h-3 w-3 text-warning" /><span>Jennifer Park</span><Badge variant="outline" className="text-xs">Pending</Badge></div>
                          <div className="flex items-center gap-2"><Check className="h-3 w-3 text-success" /><span>David Kim</span><Badge variant="outline" className="text-xs">Confirmed</Badge></div>
                          <div className="flex items-center gap-2"><Circle className="h-3 w-3 text-warning" /><span>Alex Thompson</span><Badge variant="outline" className="text-xs">Pending</Badge></div>
                        </div>
                      </div>
                      <div>
                ...
                <TabsContent value="report">
                  <div className="rounded-lg border border-border bg-card p-4">
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="text-right text-success">-42%</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <h5 className="font-medium mb-2 text-success">Highlights</h5>
                      ...
                      <div>
                        <h5 className="font-medium mb-2 text-brand">Action Items</h5>
                        <ul className="text-sm space-y-1 text-muted-foreground">
                  ...
                  <div className="rounded-lg border border-border bg-card p-4">
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-border">
                            ...
                            <th className="text-center py-2 font-medium text-brand">Us</th>
                        ...
                        <tbody>
                          <tr className="border-b border-border/50">
                            ...
                            <td className="text-center text-brand font-medium">$79/mo</td>
                          ...
                          <tr className="border-b border-border/50">
                            ...
                            <td className="text-center text-brand font-medium">Unlimited</td>
                          ...
                          <tr className="border-b border-border/50">
                            ...
                            <td className="text-center text-brand font-medium">45+</td>
                          ...
                          <tr className="border-b border-border/50">
                            ...
                            <td className="text-center text-brand font-medium">4 hrs</td>
                          ...
                          <tr>
                            ...
                            <td className="text-center text-success">✓</td>
                            <td className="text-center text-warning">Limited</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div className="p-3 rounded bg-brand/10 border border-brand/20">
                      ...
                      <ul className="text-sm mt-2 space-y-1">
                        <li>• <span className="text-brand">Integration depth</span> (45+ vs industry avg of 25)</li>
                        <li>• <span className="text-brand">Support SLA</span> (4 hrs vs competitor avg of 14 hrs)</li>
                        <li>• <span className="text-brand">Custom workflow flexibility</span></li>
                      </ul>
                    </div>
                  </div>
                </TabsContent>
